...
// PolymarketEarningsSignal hidden
...
const StockDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main id="main-content" className="container py-4 sm:py-8 px-3 sm:px-4 lg:px-8">
