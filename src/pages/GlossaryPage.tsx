...
function getGlossary(lang: string): Term[] {
  if (lang === "de") return [
    ...
    { term: "Asset Allocation", def: "Verteilung des Portfolios auf verschiedene Anlageklassen wie Aktien, Anleihen und Rohstoffe." },
    { term: "ATH", def: "All-Time High — Höchster jemals erreichter Kurs eines Wertpapiers." },
