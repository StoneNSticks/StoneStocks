...
const SYNONYMS_DE: Record<string, string[]> = {
  ...
  "scalping": ["kurzfristhandel", "skalpieren"],
  "swing-trading": ["swingtrading", "swing trade"],
  "day-trading": ["daytrading", "tageshandel", "intraday"],
  "breakout": ["ausbruch", "durchbruch"],
  "gap": ["kurslücke", "preislücke"],
  "squeeze": ["short squeeze", "leerverkäufer-squeeze"],
  "momentum": ["momentum-trading", "trendfolge"],
  "fomo": ["fear of missing out", "angst etwas zu verpassen"],
  "herdentrieb": ["herdenverhalten", "herd behavior"],
  "robo-advisor": ["robo advisor", "automatische vermögensverwaltung"],
  "neobroker": ["neo-broker", "smartphone-broker"],
  "stagflation": ["stagnation und inflation"],
  "quantitative easing": ["qe", "mengenmäßige lockerung"],
  "tapering": ["anleihekäufe reduzieren"],
  "sparerpauschbetrag": ["freibetrag", "steuerfreibetrag kapital"],
  "quellensteuer": ["withholding tax", "abzugsteuer"],
  ...
  "dividendenrendite": ["dividend yield", "ausschüttungsrendite"],
  "drip": ["dividend reinvestment plan", "dividenden-wiederanlage"],
