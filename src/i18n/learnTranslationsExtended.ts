...
export const learnTranslationsExtended: Record<string, Record<Language, string>> = {
  ...
  // ── TOC entries ──
  "learn.toc17": t("Corporate Finance", "Corporate Finance"),
  "learn.toc18": t("Rechnungswesen & Bilanzanalyse", "Accounting & Financial Statements"),
  "learn.toc19": t("Internationale Finanzmärkte", "International Finance"),
  "learn.toc20": t("Fixed Income Advanced", "Fixed Income Advanced"),
  "learn.toc21": t("ESG & Nachhaltiges Investieren", "ESG & Sustainable Investing"),
  "learn.toc22": t("Finanzregulierung & Compliance", "Financial Regulation & Compliance"),
  "learn.toc23": t("Bewertungsmethoden", "Valuation Methods"),
  "learn.toc24": t("Alternative Investments Advanced", "Alternative Investments Advanced"),
  "learn.toc25": t("Marktgeschichte & Krisen", "Market History & Crises"),
  "learn.toc26": t("Personal Finance & Altersvorsorge", "Personal Finance & Retirement"),
  "learn.toc27": t("Ökonometrie & Financial Modeling", "Econometrics & Financial Modeling"),
  "learn.toc28": t("Geldpolitik & Bankensystem", "Monetary Policy & Banking"),
