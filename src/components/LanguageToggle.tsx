  ...
  return (
    ...
    >
      ...
      <div className="flex items-center overflow-hidden">
        <span className={`transition-all font-semibold ${lang === "de" ? "text-foreground" : "text-muted-foreground"}`}>DE</span>
        <span className="mx-1 text-border">/</span>
        <span className={`transition-all font-semibold ${lang === "en" ? "text-foreground" : "text-muted-foreground"}`}>EN</span>
      </div>
    </button>
  );
}
