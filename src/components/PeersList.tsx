      ...
      const results = await Promise.all(
        filtered.map(async (sym) => {
          try {
            ...
            return { symbol: sym, name: sym, price: 0, changePercent: 0, logo: "" };
          }
        })
      );
  ...
  return (
    <div className="rounded-xl border border-border/60 bg-card p-5">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="font-display font-semibold text-sm text-muted-foreground">Similar Stocks</h3>
      </div>
      {loading ? (
          ...
          {peerData.map((peer) => (
            ...
            >
              ...
              <div className="text-right flex-shrink-0">
                ...
                <div className={`text-[11px] font-medium tabular-nums ${priceChangeColor(peer.changePercent)}`}>
